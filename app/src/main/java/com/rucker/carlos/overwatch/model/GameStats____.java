...
public class GameStats____ {
    ...
    @SerializedName("environmental_kills_most_in_game")
    @Expose
    ...
    @SerializedName("hero_damage_done_most_in_game")
    @Expose
    private Double heroDamageDoneMostInGame;
    @SerializedName("kill_streak_best")
    @Expose
    private Double killStreakBest;
    @SerializedName("kpd")
    @Expose
    private Double kpd;
    ...
    @Expose
    private Double objectiveTimeMostInGame;
    ...
    @SerializedName("recon_assists_most_in_game")
    @Expose
    private Double reconAssistsMostInGame;
    @SerializedName("shield_generator_destroyed_most_in_game")
    @Expose
    private Double shieldGeneratorDestroyedMostInGame;
    @SerializedName("shield_generators_destroyed")
    @Expose
    private Double shieldGeneratorsDestroyed;
    ...
    @SerializedName("teleporter_pad_destroyed_most_in_game")
    @Expose
    private Double teleporterPadDestroyedMostInGame;
    ...
    @Expose
    private Double timeSpentOnFireMostInGame;
    @SerializedName("turrets_destroyed")
    @Expose
    private Double turretsDestroyed;
    @SerializedName("turrets_destroyed_most_in_game")
    @Expose
    ...
    public Double getKillStreakBest() {
    ...
    public Double getObjectiveTimeMostInGame() {
        return objectiveTimeMostInGame;
    }

    public void setObjectiveTimeMostInGame(Double objectiveTimeMostInGame) {
    ...
    public Double getShieldGeneratorDestroyedMostInGame() {
        return shieldGeneratorDestroyedMostInGame;
    }

    public void setShieldGeneratorDestroyedMostInGame(Double shieldGeneratorDestroyedMostInGame) {
        this.shieldGeneratorDestroyedMostInGame = shieldGeneratorDestroyedMostInGame;
    }

    public Double getShieldGeneratorsDestroyed() {
        return shieldGeneratorsDestroyed;
    }

    public void setShieldGeneratorsDestroyed(Double shieldGeneratorsDestroyed) {
        this.shieldGeneratorsDestroyed = shieldGeneratorsDestroyed;
    }
    ...
    public Double getTeleporterPadDestroyedMostInGame() {
        return teleporterPadDestroyedMostInGame;
    }

    public void setTeleporterPadDestroyedMostInGame(Double teleporterPadDestroyedMostInGame) {
        this.teleporterPadDestroyedMostInGame = teleporterPadDestroyedMostInGame;
    }
    ...
    public Double getTimeSpentOnFireMostInGame() {
        return timeSpentOnFireMostInGame;
    }

    public void setTimeSpentOnFireMostInGame(Double timeSpentOnFireMostInGame) {
